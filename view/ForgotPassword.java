...
public class ForgotPassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ForgotPassword page");
        ...
        setSize(new java.awt.Dimension(613, 422));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        boolean b = service.Forgotsevice.ForgotPassword(jTextField1.getText(),jPasswordField1.getText());
        if(b){
            JOptionPane.showMessageDialog(this, "Password Update succesfully" );
        }else{
